...
1. **GitHub Security Advisories**: Use the [Security Advisories](https://github.com/BRDK-GitHub/as-help-mcp/security/advisories) feature to privately report the vulnerability.
